...
We have an excellent Post Doctoral Student working with us this year, [https://stephbuon.github.io/][Steph Buongiorno]. Steph is also available to help with any questions you have about the material, assignments, or anything else.

  - **Steph Buongiorno:** Office hours TBD
...
library(tibble)
assignments <- tibble(
  Assignment = c("Homework (30 x 5)", "Code Review (10 x 5)"),  
  Points = c(30*5, 10*5)
)
