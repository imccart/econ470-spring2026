...
## Code Review
One of the best ways to improve your own coding is to see other people's code and learn from them. We'll do this through a peer code review and replication. Please see the [Peer Review](/assignments/code-review) for more details.