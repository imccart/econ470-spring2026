...
knitr::kable(test.data, col.names=c("2018"),
...
3. Now repeat the same filters from part 2 but also focus only on counties in which plans are approved as per the service area files. With these data, provide a table of the average enrollments for each plan type. (2 points)
